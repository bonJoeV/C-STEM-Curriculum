...
Features:
- High-pass filtering to isolate high-frequency taps.
- Tap detection based on acceleration spikes.
- Real-time graphing of filtered acceleration values.
- Cooldown period to avoid multiple detections for a single tap.
...
HIGH_PASS_ALPHA = 0.9            # High-pass filter coefficient (0.8–0.99)
